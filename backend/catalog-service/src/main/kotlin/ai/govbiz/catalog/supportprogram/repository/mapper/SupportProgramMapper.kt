...
interface SupportProgramMapper {
    ...
    fun findCatalogId(): String

    fun findSourceRevision(@Param("sourceCode") sourceCode: String): Long

    fun advanceSourceRevision(@Param("sourceCode") sourceCode: String): Int

    fun findPresentBySource(@Param("sourceCode") sourceCode: String): List<SupportProgramDbRow>
