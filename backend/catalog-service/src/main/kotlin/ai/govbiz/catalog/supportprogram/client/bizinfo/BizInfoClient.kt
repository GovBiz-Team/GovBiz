package ai.govbiz.catalog.supportprogram.client.bizinfo

import ai.govbiz.catalog.supportprogram.client.bizinfo.config.BizInfoClientProperties
import ai.govbiz.catalog.supportprogram.client.bizinfo.dto.BizInfoPage
...
import ai.govbiz.catalog.supportprogram.client.bizinfo.helper.BizInfoPageDecoderHelper
import ai.govbiz.catalog.supportprogram.client.bizinfo.helper.executeBizInfoHttpCall
...
class BizInfoClient(
    ...
    private fun fetchPage(serviceKey: String, pageNumber: Int): BizInfoPage =
        executeBizInfoHttpCall {
            ...
            BizInfoPageDecoderHelper.decode(body, PAGE_SIZE)
        }
